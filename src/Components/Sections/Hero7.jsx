...
function Hero7() {
    return (
        <div className="aasarah">
            <div className="mdt">
                <p className="mdtt">Meet Our Dental Team</p>
                <h1>Commited to Your Style</h1>
                <p className="edt">Our experienced dental team is here to make every visit positive and personalized. With gentle hands and caring hearts.</p>
            </div>
            <div className="allsarah">
                <div className="sarah">
